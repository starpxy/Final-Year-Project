...
class FrontEndInterface:
    ...
    def set_query_match_lines(self, query_match_lines):
        self.__query_match_lines = query_match_lines

    def get_query_match_lines(self):
        return self.__query_match_lines
