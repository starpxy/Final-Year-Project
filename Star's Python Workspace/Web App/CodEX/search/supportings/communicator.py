...
from search.supportings.network import MessageDumper
...
class CommunicationServer:
    ...
    def __config_connection(self, socket_name, listen_number=1):
        ...
        self.__connection_socket.bind(configs['paths']['socket_path'] + '/' + socket_name)
    ...
    def receive_message(self, socket_name, listen_number=1):
        ...
        if message.get_is_modified():
            ...
            LogWriter().write_info_log('Message Received Successfully.')
