class Results:
    ...
    def __init__(self, numOfResults=0, documentList=[], plagiarismList=[], matchingLines=None, globalSimilarity=None,
                 matchingBlocks=None, componentDocuments=[]):
    ...
    def to_dict(self):
        """
        @author:Star
        :return: dict to return.
        """
        return {'numOfResults': self.numOfResults,
                'documentList': self.documentList,
                'plagiarismList': self.plagiarismList,
                'matchingLines': self.matchingLines,
                'globalSimilarity': self.globalSimilarity,
                'matchingBlocks': self.matchingBlocks,
                'componentDocuments': self.componentDocuments}

    @staticmethod
    def from_dict(dict):
        """
        @author:Star
        :param dict: dict to get info
        :return: Results object
        """
        result = Results(dict['numOfResults'], dict['documentList'], dict['plagiarismList'], dict['matchingLines'],
                         dict['globalSimilarity'], dict['matchingBlocks'], dict['componentDocuments'])
        return result
